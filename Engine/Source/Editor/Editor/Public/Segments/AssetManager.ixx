...
{
	export struct AssetManager :public Segment
	{
	...
	auto AssetManager::onDrawGui(void* id, std::string const& name, CustomDrawFn open_fn, CustomDrawFn before_open_fn) noexcept -> void
	{
