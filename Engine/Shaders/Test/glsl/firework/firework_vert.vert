...
void main() {
    ...
    vec4 modelPosition = billboardMat * vec4(inPosition * vec3(0.05,0.05,0.05) ,1.0);

    gl_Position = view_ubo.proj * view_ubo.view * (vec4(modelPosition.xyz + pos_lifetime.xyz + PushConstants.model[3].xyz, 1.0));
