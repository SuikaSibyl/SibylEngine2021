...
// DescriptorAllocation: This class wraps an allocation that is returned from the
// DescriptorAllocator::Allocate method.
// The DescriptorAllocation class also stores a pointer back to the page it came from
