...
{
	// Static definitions.
	std::mutex DX12ResourceStateTracker::ms_GlobalMutex;
	bool DX12ResourceStateTracker::ms_IsLocked = false;
	DX12ResourceStateTracker::ResourceStateMap DX12ResourceStateTracker::ms_GlobalResourceState;
