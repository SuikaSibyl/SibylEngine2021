...
inline int GetKeyCode(int GLFWCode, int WinCode)
{
	...
	{
	case SIByL::RasterRenderer::OpenGL: return GLFWCode; break;
	case SIByL::RasterRenderer::DirectX12: return WinCode; break;
	case SIByL::RasterRenderer::CpuSoftware: return -1; break;
	case SIByL::RasterRenderer::GpuSoftware: return -1; break;
...
#define SIByL_KEY_LEFT_CONTROL       (GetKeyCode(341,VK_SPACE))			
